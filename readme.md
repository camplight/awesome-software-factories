...
- [AIWG](https://github.com/jmagly/aiwg) - Provides persistent project artifacts, specialist workflows, verification links, and human phase gates for a specification-driven software lifecycle.
...
- [Finn-loop](https://github.com/finna/Finn-loop) - Connects interviewed specifications in Linear to verified implementation, independent pull-request review, required checks, and human merge authority.
...
- [OpenRewrite](https://docs.openrewrite.org/) - Provides an open-source semantic-refactoring engine and reusable recipes for repeatable framework migrations, security fixes, dependency changes, and source maintenance.
...
- [Better Symphony](https://github.com/SabatinoMasala/better-symphony) - Runs tracker- and schedule-driven coding workflows with isolated workspaces, configurable agent stages, retries, pull-request review, and optional sandboxing.
- [Buzz](https://github.com/block/buzz) - Gives software teams a shared workspace for agent branches, patches, reviews, CI events, and signed append-only collaboration records.
...
- [Fusion](https://github.com/Runfusion/Fusion) - Coordinates multi-node agents across planning, implementation, review, and delivery stages for software changes.
...
- [OrgOps](https://github.com/camplight/orgops) - Provides a self-hostable, auditable coordination layer where humans and external agent runtimes collaborate through an append-only event bus.
...
- [SWE-AF](https://github.com/Agent-Field/SWE-AF) - Runs multi-agent software builds from planning and dependency-aware implementation through review, integration testing, acceptance verification, and pull-request delivery.
- [WorkDock](https://github.com/workdock-dev/engine) - Connects issue trackers, Git providers, coding harnesses, and sandboxes through durable jobs that publish changes and continue through review feedback.
...
- [HCLTech AI Force.Software.Mod](https://www.hcltech.com/ai-led-modernization) - Applies an industrialized service and agentic platform to application discovery, code and UI transformation, testing, deployment, and post-release optimization.
